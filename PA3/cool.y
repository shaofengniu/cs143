...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    | formal
    { SET_NODELOC(@1); $$ = single_Formals($1); }
    | formal_list ',' formal
    { SET_NODELOC(@1); $$ = append_Formals($1, single_Formals($3)); }
    ;
    ...
    | expr '+' expr
    { SET_NODELOC(@1); $$ = plus($1, $3); }
    | expr '-' expr
    { SET_NODELOC(@1); $$ = sub($1, $3); }
    | expr '*' expr
    { SET_NODELOC(@1); $$ = mul($1, $3); }
    | expr '/' expr
    { SET_NODELOC(@1); $$ = divide($1, $3); }
    | '~' expr
    { SET_NODELOC(@1); $$ = neg($2); }
    | expr '<' expr
    { SET_NODELOC(@1); $$ = lt($1, $3); }
    | expr LE expr
    { SET_NODELOC(@1); $$ = leq($1, $3); } 
    | expr '=' expr
    { SET_NODELOC(@1); $$ = eq($1, $3); }
    | NOT expr
